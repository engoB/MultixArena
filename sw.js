...
const SHELL_CACHE = 'multiarena-shell-4.6.3';
const MEDIA_CACHE = 'multiarena-media-4.6.3';
...
self.addEventListener('activate', event => {
  event.waitUntil(caches.keys()
    ...
    .then(async () => {
      ...
      clients.forEach(client => client.postMessage({ type: 'APP_UPDATED', version: '4.6.3' }));
    }));
});
